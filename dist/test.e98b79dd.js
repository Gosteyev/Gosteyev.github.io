...
var array = [33, 444, 2, 90, 55, 343];

var makeChunks = function makeChunks(arr, size) {
  var result = [];
  ...
  while (end < arr.length) {
    var subArr = arr.slice(begin, end);
    result.push(subArr);
    begin += size;
    end += size;
  }

  var last = arr.slice(end - size, arr.length);
  result.push(last);
  return result;
};

window.makeChunks = makeChunks; //////////////REVERSE STRING

var reversStr = function reversStr(str) {
  var result = [];
...
var makeReverse = function makeReverse(str) {
  var arr = str.split('');
  var res = arr.reduce(function (acc, next) {
    return acc + next;
  }, '');
}; ///////////////////IS PALINDROM
...
// })();
//   </script>
},{}],"../../../.nvm/versions/node/v12.16.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v12.16.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","test.js"], null)
